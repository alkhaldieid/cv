...
\begin{itemize} 
\item I am a \textbf{Certified Professional Data Scientist} with a Ph.D. in Electrical Engineering and over 8 years of specialized research in Artificial Intelligence (AI) and autonomous systems. My research has contributed to cutting-edge advancements in image classification and CNN optimization, with several publications in prestigious journals like \textit{IEEE Access}.

In addition to my academic achievements, I bring entrepreneurial experience as an AI Consultant at NMK, a startup at the forefront of autonomous driving technology. I have led research initiatives, creating experimental environments and delivering AI-powered solutions for assisted automated driving systems. My ability to innovate and lead high-performing teams allows me to deliver impactful results in both academic and industry settings.

As a passionate problem-solver, I am seeking to leverage my expertise and certifications to drive digital transformation and operational excellence across a variety of domains.
%  Ph.D. in Electrical Engineering with over 8 years of focused academic research in AI and autonomous systems. Experienced in developing innovative methods for image classification and optimizing CNN ensembles for maximum accuracy, as evidenced by publications in prestigious journals like IEEE Access.
...
Aug 2024 - Present | \textbf{Deputy Site Manager, Alhabib Trading Company} \textit{\textbf{ (Construction and Engineering)}}
